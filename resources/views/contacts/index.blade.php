<x-layouts.app>
    ...
    <div class="py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            @if (session('success'))
                <div
                    class="mb-6 p-4 bg-green-100 border-l-4 border-green-500 text-green-700 dark:bg-green-900 dark:border-green-700 dark:text-green-100">
                    {{ session('success') }}
                </div>
            @endif
    ...
    <script>
        // Delete handler with error simulation
        function handleDelete(event) {
            ...
            if (simulateError) {
                ...
                hiddenInput.name = 'simulate_error';
                hiddenInput.value = '1';
                form.appendChild(hiddenInput);
            }

            // Always submit the form explicitly
            form.submit();
            return false;
        }
        // Checkbox URL param handler
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const checkbox = document.getElementById('simulate-error');
            if (checkbox) {
                const urlParams = new URLSearchParams(window.location.search);
                checkbox.checked = urlParams.has('simulate_error');
            }
        });
    </script>
</x-layouts.app>
